...
# Azure Legend Platform Deployment (Minimal Resources)
# This script deploys Legend with minimal resource requirements
...
echo "🚀 Azure Legend Platform Deployment (Minimal Resources)"
echo "======================================================"
...
# Deploy Legend Engine (Minimal Resources)
deploy_legend_engine() {
    print_status "Deploying Legend Engine (Minimal Resources)..."
...
# Deploy Legend SDLC (Minimal Resources)
deploy_legend_sdlc() {
    print_status "Deploying Legend SDLC (Minimal Resources)..."
...
# Deploy Legend Studio (Minimal Resources)
deploy_legend_studio() {
    print_status "Deploying Legend Studio (Minimal Resources)..."
...
# Main deployment
main() {
    echo "Starting Legend Platform deployment on Azure AKS (Minimal Resources)..."
    echo ""
