...
# Kubernetes Deployment Script for Legend Platform
# Orchestrates deployment of all Legend services to Kubernetes
...
source "$SCRIPT_DIR/shared/lib/common-functions.sh"
...
deploy_service() {
    local service=$1
    local deploy_script="$SCRIPT_DIR/components/$service/deploy.sh"
